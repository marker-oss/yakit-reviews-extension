  ...
  return (
    <section className="stack">
      ...
      <section className="panel">
        ...
        <p className="muted">
          Чтобы браузер не блокировал запросы виджета (CORS), в .env сервера должен быть указан адрес магазина:
          REVIEWS_SHOP_ORIGIN=https://ваш-магазин.ru — при необходимости через запятую с www-вариантом. Изменения в Тег
          Менеджере попадают на сайт только после публикации контейнера.
        </p>
      </section>
    </section>
  )
