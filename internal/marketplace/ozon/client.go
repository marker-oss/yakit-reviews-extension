...
func (c *Client) fetchPage(ctx context.Context, cursor string) (ozonReviewListResponse, error) {
	...
	resp, err := c.executor.Do(ctx, c.httpClient, apihttp.OzonPolicy(), apihttp.Read, func(attemptCtx context.Context) (*http.Request, error) {
		req, err := http.NewRequestWithContext(attemptCtx, http.MethodPost, c.baseURL+"/v1/review/list", bytes.NewReader(body))
		if err != nil {
			return nil, err
		}
...
func (c *Client) FetchQuestions(ctx context.Context, since time.Time, cursor string) ([]marketplace.Question, string, error) {
	...
	resp, err := c.executor.Do(ctx, c.httpClient, apihttp.OzonPolicy(), apihttp.Read, func(attemptCtx context.Context) (*http.Request, error) {
		req, err := http.NewRequestWithContext(attemptCtx, http.MethodPost, c.baseURL+"/v1/question/list", bytes.NewReader(body))
		if err != nil {
			return nil, err
		}
		req.Header.Set("Client-Id", c.clientID)
...
func (c *Client) fetchQuestionAnswer(ctx context.Context, questionID, sku string) (*marketplace.Answer, error) {
	...
	resp, err := c.executor.Do(ctx, c.httpClient, apihttp.OzonPolicy(), apihttp.Read, func(attemptCtx context.Context) (*http.Request, error) {
		req, err := http.NewRequestWithContext(attemptCtx, http.MethodPost, c.baseURL+"/v1/question/answer/list", bytes.NewReader(body))
		if err != nil {
			return nil, err
		}
		req.Header.Set("Client-Id", c.clientID)
...
func (c *Client) PublishQuestionAnswer(ctx context.Context, externalQuestionID, sku, text string) error {
	...
	resp, err := c.executor.Do(ctx, c.httpClient, apihttp.OzonPolicy(), apihttp.Write, func(attemptCtx context.Context) (*http.Request, error) {
		req, err := http.NewRequestWithContext(attemptCtx, http.MethodPost, c.baseURL+"/v1/question/answer/create", bytes.NewReader(body))
		if err != nil {
			return nil, err
		}
		req.Header.Set("Client-Id", c.clientID)
...
func (c *Client) PublishReply(ctx context.Context, externalReviewID, text string) error {
	...
	resp, err := c.executor.Do(ctx, c.httpClient, apihttp.OzonPolicy(), apihttp.Write, func(attemptCtx context.Context) (*http.Request, error) {
		req, err := http.NewRequestWithContext(attemptCtx, http.MethodPost, c.baseURL+"/v1/review/comment/create", bytes.NewReader(body))
		if err != nil {
			return nil, err
		}
		req.Header.Set("Client-Id", c.clientID)
...
func (c *Client) fetchProductPage(ctx context.Context, cursor string) (ozonProductListResponse, error) {
	...
	resp, err := c.executor.Do(ctx, c.httpClient, apihttp.OzonPolicy(), apihttp.Read, func(attemptCtx context.Context) (*http.Request, error) {
		req, err := http.NewRequestWithContext(attemptCtx, http.MethodPost, c.baseURL+"/v3/product/list", bytes.NewReader(body))
		if err != nil {
			return nil, err
		}
		req.Header.Set("Client-Id", c.clientID)
