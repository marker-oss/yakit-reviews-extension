...
func LoadFromEnv() (Config, error) {
	...
	cfg := Config{
		...
		Web: WebConfig{
			ProductURLTemplate: envString("REVIEWS_SITE_PRODUCT_URL_TEMPLATE", "https://shegida.ru/search?query={seller_article_url}"),
			ProductLinksPath:   envString("REVIEWS_SITE_PRODUCT_LINKS", "data/shegida-product-links.json"),
		},
		Marketplaces: MarketplaceConfig{
			WB: WBConfig{
