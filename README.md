...
| Админка отзывов | Виджет на карточке товара |
|---|---|
| ![Админка со списком отзывов, фильтрами и ответами магазина](docs/assets/screenshots/admin-reviews.png) | ![Виджет отзывов на карточке товара](docs/assets/screenshots/widget-product-page.png) |
