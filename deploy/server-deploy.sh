...
REPO_URL="${REPO_URL:-git@github.com:marker-oss/yakit-reviews-extension.git}"
...
install -m 0644 "$SRC_DIR/data/shegida-product-links.json" "$APP_DIR/data/shegida-product-links.json"
